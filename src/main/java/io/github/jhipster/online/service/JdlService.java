...
public class JdlService {
    ...
    public void applyJdl(User user, String organizationName, String projectName, JdlMetadata jdlMetadata, String applyJdlId, GitProvider gitProvider) {
        ...
        try {
            ...
            this.logsService.addLog(applyJdlId, "Cloning Git repository `" + organizationName +
                "/" + projectName + "`");
            ...
            if (gitProvider.equals(GitProvider.GITHUB)) {
                pullRequestNumber = this.githubService.createPullRequest(user, organizationName, projectName, pullRequestTitle,
                ...
                pullRequestNumber = this.gitlabService.createPullRequest(user, organizationName, projectName, pullRequestTitle, branchName, pullRequestBody);
